...
import {
  Filter, Star, Heart, ShoppingBag, Package, Sparkles
} from 'lucide-react'
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4">
        ...
        {!productsLoading && !productsError && sortedProducts.length === 0 && (
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-12 text-center">
            ...
            <p className="text-gray-600 text-lg">目前沒有符合條件的商品</p>
            <p className="text-gray-500 text-sm mt-2">試試調整篩選條件或瀏覽其他分類</p>
            <div className="mt-6 flex flex-wrap justify-center gap-2">
              <Link href="/" className="text-blue-500 hover:text-blue-600">
                返回首頁
              </Link>
              <span className="text-gray-300">|</span>
              <Link href="/best-sellers" className="text-blue-500 hover:text-blue-600">
                熱銷排行
              </Link>
              <span className="text-gray-300">|</span>
                  ...
                  <Link href={`/products/${product.slug}`}>
                    <div className="relative aspect-square bg-gray-100">
                      ...
                      <div className="absolute top-2 left-2 flex flex-col gap-1">
                        ...
                        {product.isFeatured && (
                          <span className="bg-purple-500 text-white px-2 py-0.5 rounded text-xs font-bold flex items-center gap-1">
                            <Sparkles size={10} />
                            精選
                          </span>
                        )}
                    ...
                    <div className="p-3">
                      ...
                      <div className="flex items-center justify-between mb-2 text-xs">
                        <span className="text-gray-500">已售 {product.soldCount || 0}</span>
                        {rating > 0 && (
                      ...
                      <div className="flex items-end justify-between">
                        <div className="flex flex-col">
                          ...
                          <span className={`text-base font-bold ${hasDiscount ? 'text-red-500' : 'text-gray-800'}`}>
                            ${price}
                          </span>
                        </div>
                      </div>
                          ...
                          <div>
                            ...
                            {rating > 0 && (
                              <div className="flex items-center gap-3 text-sm mb-2">
                                ...
                                <span className="text-gray-600">{product.reviewCount || 0} 則評價</span>
                                <span className="text-gray-400">|</span>
                                <span className="text-gray-600">已售 {product.soldCount || 0}</span>
                              </div>
                            )}
                          </div>
