  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">尺寸管理</h1>
          <p className="text-gray-600 mt-1">點選要新增的尺寸（10-50號）</p>
        </div>
        <Link
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <div className="flex items-center justify-between bg-blue-50 rounded-lg p-4">
              <div className="text-sm text-gray-700">
                已選擇 <span className="font-bold text-blue-600 text-lg">{selectedSizes.size}</span> 個尺寸：
              ...
              <button
                ...
                disabled={creating}
                className="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium text-lg"
              >
                {creating ? '新增中...' : `確定新增`}
              </button>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
          ...
          <p className="text-sm text-gray-500 mt-1">共 {sizeCharts.length} 個尺寸（滑鼠移到尺寸上可編輯或刪除）</p>
        </div>
              ...
              {[...sizeCharts]
                ...
                .map((size) => (
                  <div
                    key={size.id}
                    className={`
                      group relative inline-flex items-center gap-2 px-5 py-3 rounded-xl border-2 transition-all
                      ${size.isActive
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-green-900">無限庫存模式</p>
            <p className="text-xs text-green-700 mt-1">系統已啟用無限庫存模式，客人可直接購買任何尺寸，無需管理庫存數量</p>
          </div>
        </div>
      </div>
